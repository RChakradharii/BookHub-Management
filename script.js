...
//         const coverImage = book.cover_i ? `https://covers.openlibrary.org/b/id/${book.cover_i}-L.jpg` : 'https://via.placeholder.com/150?text=No+Cover+Available';
        
//         bookCard.innerHTML = `
//             <img src="${coverImage}" alt="Book Cover" class="book-cover">
//             <h3>${book.title}</h3>
//             <p>${book.author_name ? book.author_name.join(', ') : 'Unknown Author'}</p>
//             <p class="language-info">Language: ${book.language ? book.language.join(', ') : 'Not Available'}</p>
//             <a href="https://openlibrary.org${book.key}" target="_blank" class="read-button">Read Book</a>
//             <button class="view-details-button" onclick="showBookDetails('${book.key}')">View Details</button>
//         `;
